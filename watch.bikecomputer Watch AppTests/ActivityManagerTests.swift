...
final class ActivityManagerTests: XCTestCase {
    ...
    func testGPXGenerationAndUpload() async {
        // Mock location data
        let mockLocations = [
            CLLocation(latitude: 52.520008, longitude: 13.404954, altitude: 34.0, horizontalAccuracy: 5.0, verticalAccuracy: 5.0, timestamp: Date()),
            CLLocation(latitude: 52.520180, longitude: 13.405123, altitude: 36.0, horizontalAccuracy: 5.0, verticalAccuracy: 5.0, timestamp: Date().addingTimeInterval(60))
        ]
